        ...
        <div className="container">
          ...
          <div className="row mb-5 media-partner__logos">
            <div className="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos-disabled="fade" data-aos-delay="300">
              <a href="https://brewbox.community/" target="_blank" alt="Brewbox" rel="noopener noreferrer">
            ...
            <div className="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos-disabled="fade" data-aos-delay="400">
              <a href="https://associazione.python.it/" target="_blank" alt="Python Italia" rel="noopener noreferrer">
          ...
          <div className="row mb-5 media-partner__logos">
            <div className="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos-disabled="fade" data-aos-delay="200">
              <a href="https://www.grusp.org/" target="_blank" alt="Grusp" rel="noopener noreferrer">
              <img src="/images/grusp.svg" alt="GRUSP" className="img-fluid img-full" />
              </a>
            </div>
            <div className="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos-disabled="fade" data-aos-delay="200">
              <a href="https://cremaweb.org/" target="_blank" alt="CremaWeb" rel="noopener noreferrer">
          ...
          <div className="row mb-5 media-partner__logos">
            <div className="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos-disabled="fade" data-aos-delay="200">
              <a href="http://www.bolognajs.com/" target="_blank" alt="Bologna JS" rel="noopener noreferrer">
              <img src="/images/bolognajs.svg" alt="Bologna JS" className="img-fluid img-full" />
              </a>
            </div>
            <div className="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos-disabled="fade" data-aos-delay="200">
              <a href="https://www.accademiasantagiulia.it/" target="_blank" alt="Accademia Santa Giulia" rel="noopener noreferrer">
